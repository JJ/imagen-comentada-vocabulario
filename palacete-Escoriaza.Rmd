---
title: Vocabulario arquitectónico del palacete de Escoriaza o palacio del Vizconde,
...
output:
  ...
  pdf_document:
    keep_tex: true
abstract: |
  El palacete de Escoriaza es una construcción de principios del siglo XX en estilo neonazarí, con un vocabulario tomado de la Alhambra y de la arquitectura musulmana principalmente andalusí. Su arquitecto, Modesto Cendoya, fue posteriormente conservador de la Alhambra, y tiene otros grandes ejemplos de arquitectura regionalista y modernista en la ciudad de Granada. En este trabajo analizamos el vocabulario arquitectónico usado en la construcción.
...
> También disponible [en PDF](https://github.com/JJ/imagen-comentada-vocabulario/releases/download/v1.0/palacete-Escoriaza.pdf).
...
De hecho, estos son los *picos* de la Torre de los Picos que le sirve de inspiración y que le dio nombre originalmente a esta construcción, como aparece en la imagen de archivo [@vistas:granada].
...
Aparentemente con la misma inscripción que se encuentra en la Alhambra, "Sólo Alá es vencedor". La posición del panel es similar a la de arcos en la Alhambra con puertas adinteladas a los lados; sin embargo aquí, una vez más, se emplea sin ninguna relación con ningún otro elemento y es puramente decorativo.
...
Los números se replican también en la puerta en ladrillo abajo a la izquierda; se trata del mismo tipo de elemento, pero en este caso usa ladrillo tradicional, como el resto del arco y chambrana^[Aunque generalmente *alfiz* y *chambrana* se refieren al mismo tipo de elemento arquitectónico, aquí estamos utilizando el último término para elementos consotructivos modernistas post-nazaríes, y el primero para marcos que siguen un vocabulario nazarí]. En el caso de las albanegas el ladrillo está colocado a soga y tizón.
...
El capitel también presenta un *equino* de esquinas curvadas, con un ábaco prácticamente plano; el collarino está decorado con hojas de palmera, como en el otro caso, y el capitel es cuadrado con una decoración que parece un arco. 

### 23: Modillones

Soportando un balcón cerrado de obra, estos modillones están compuestos por dos prismas alargados y redondeados, que parecen resultar del alargamiento en horizontal de los clásicos "rollos". Parecen en este caso una estilización de los modillones de lóbulos tan característicos de la arquitectura musulmana mediterránea [@upm34252]. Comparando una vez más la foto clásica con la actual, vemos que en el original había tres lóbulos (Véase la Figura 4, un poco más abajo), siendo más similares a un modillón de rollos que actualmente.
...
Pero quizá lo más interesante de esta versión original es el balcón que había sobre el cierre, con merlones y almenas en piedra, de disposición similar a las del torreón actual, pero de menor tamaño y aparentemente en ladrillo. Esta disposición se conserva en la actualidad, aunque se ha uniformado la pintura con el resto del torreón; tampoco se ve bien en la imagen actual, puesto que está detrás de un árbol que lo tapa.

### 26: Cornisa con decoración nazarí

La cornisa, en tres bandas, está decorada de forma difícil de determinar. Esta cornisa no tiene solución de continuidad con los arcos sobre el balcón, estando situada justo por encima del alfiz de los mismos, y extiende el estilo y decoración a toda la fachada del cuerpo principal del edificio.

La dos bandas superiores parecen ligeramente adelantadas con respecto a la principal, la última continuándose con el voladizo de madera que se ha indicado con el número 3.

## Conclusiones

Examinando este edificio, uno puede ciertamente ver las polémicas que han acompañado al arquitecto original [@lopera1977decision]. Aunque adopta un estilo modernista neo-nazarí relativamente coherente (con elementos que se pueden calificar genéricamente como neo-islamistas) la acumulación de patrones y materiales muy diferents podrían conducirnos a calificar de pastiche el resultado final si se examina con cierto detenimiento, como se ha hecho^[Desde luego, no hace más fácil la labor de este que escribe, que no sabía donde se metía cuando su mujer le sugirió que usara este edificio para el trabajo.].

Sin embargo, el resultado en conjunto no resulta desagradable a la vista, y sobre todo es un diccionario casi completo del vocabulario arquitectónico usado en el arte musulmán en España, que por sí solo puede cubrir las necesidades de un estudiante de historia del arte que se acerque al mismo.
